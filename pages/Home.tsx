...
import { Hammer, PencilRuler, PaintBucket, Briefcase, Filter } from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* SECCIÓN 2: SERVICIOS (4 Cards - 4 Columns Desktop / 1 Column Mobile) */}
      ...
      {/* SECCIÓN 3: PROYECTOS DESTACADOS (6 Cards Grid + Filter) */}
      <section className="py-24 bg-costa-slate relative">
        <div className="container mx-auto px-6">
      ...
      {/* SECTION 4: CTA FINAL */}
      <section className="py-24 bg-costa-navy relative overflow-hidden">
