  ...
  return (
    <div className="pt-20">
      <Hero 
        ...
        description="Pasión por construir un futuro sustentable."
      ...
      <section className="bg-white py-20">
         <div className="container mx-auto px-6 text-center max-w-4xl">
            <span className="text-costa-lime font-bold uppercase tracking-widest text-xs">Quiénes Somos</span>
            <h2 className="text-3xl md:text-4xl font-display font-bold text-costa-navy mt-4 mb-8">Compromiso y Calidad</h2>
